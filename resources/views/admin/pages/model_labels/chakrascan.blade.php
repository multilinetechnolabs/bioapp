        ...
        $(document).ready(function() {
            ...
            $('#model_labels').DataTable({
                ...
                columns: [
                    ...
                    { data: 'point.name', name: 'point.name', defaultContent: '' },
                    { data: 'point_x', name: 'point_x', searchable: false },
                    { data: 'point_y', name: 'point_y' , searchable: false},
                    { data: 'point_z', name: 'point_z' , searchable: false},
                    { data: 'label', name: 'label', searchable: false },
                    { data: 'label_x', name: 'label_x', searchable: false },
                    { data: 'label_y', name: 'label_y', searchable: false },
                    { data: 'label_z', name: 'label_z', searchable: false },
                    {
