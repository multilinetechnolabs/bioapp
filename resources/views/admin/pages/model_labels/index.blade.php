...
@section('page-title')Model Labels@stop
@section('styles')
    @parent
@stop
@section('content')
    ...
    <div id="content-container">
        <div class="admin-page-header">
            <h2 class="admin-page-title">{{ __('Model Labels') }}</h2>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="pair_id" name="pair_id" required>
                                @foreach(\App\Models\Pair::orderBy('name', 'asc')->get() as $pair)
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.save-btn').click(function(e) {
                ...
                if (!data.scan_type) { alert('Scan type must be filled out.'); $('#scan_type').focus(); return; }
            ...
            $('#model_labels').DataTable({
                processing: true,
                serverSide: true,
                ajax: { url: '{{ env("APP_WEB_API_URL") }}/{{ env("APP_WEB_API_VERSION") }}/model_labels/datatables' },
                columns: [
                    { data: 'id', name: 'id' },
