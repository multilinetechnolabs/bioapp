...
@section('page-title', $client->name . ' Bio')
...
@section('content')
    <main class="modern-main-content modern-main-content--fluid">
        <div id="content-container" class="modern-data-cache-wrap"
             ng-cloak ng-controller="DataCacheClientShowBioCtrl as ctrl">
            ...
            <header class="modern-page-header" ng-if="ctrl.loaded">
                <div>
                    <h1 class="modern-page-title">{{ $client->name }} &mdash; Bio</h1>
                ...
                <div class="table-responsive modern-data-cache-table-shell"
                    ...
                    <table border="1" class="modern-data-cache-table">
                        ...
                        <tbody ng-repeat="(radical, pairs) in ctrl.displayed_pairs | where: { scan_type: ctrl.scan_type } | filter:{ name: ctrl.searchText } | orderBy: 'radical' | groupBy: 'radical'">
                            <tr>
                                <td class="header-radical header-radical-<% $index %>"  style="color: #000;" colspan="6"><% radical %></td>
                            </tr>
