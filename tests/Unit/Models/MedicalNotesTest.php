...
class MedicalNoteTest extends TestCase
{
    ...
    public function testColumnTypes()
    {
        ...
        $this->assertEquals(Schema::getColumnType($tableName, 'date_noted'), 'date');
