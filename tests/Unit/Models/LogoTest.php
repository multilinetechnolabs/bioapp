...
class LogoTest extends TestCase
{
    ...
    public function testColumnTypes()
    {
        ...
        $this->assertEquals(Schema::getColumnType($tableName, 'file_name'), 'string');
        $this->assertEquals(Schema::getColumnType($tableName, 's3_name'), 'string');
